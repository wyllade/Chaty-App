-- ============================================
-- CHATY - Full Database Schema + Setup
...
CREATE POLICY "Stories viewable by followers" ON stories FOR SELECT USING (
...
CREATE POLICY "Participants can view members" ON conversation_participants FOR SELECT USING (
